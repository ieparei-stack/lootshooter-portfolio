...
export function createSettingsPanel() {
  ...
  hint.textContent = '클릭: 마우스 잠금 · ESC: 해제 (슬라이더는 해제 상태에서 조절) · 좌클릭: 사격 · 우클릭 유지: 정조준 · R: 재장전 · X: 탄착군 지우기 · 1~3 / 휠: 무기 전환 · ESC 후 왼쪽 아래: 무기 튜닝 · 흰 궤적: 이론 반동(무작위 없음) · P: 궤적 켜기/끄기 · 사격장 끝 문을 지나 구역 1에 들어가면 웨이브 시작 (3웨이브) · 클리어하면 다음 문이 열림: 구역 1 → 2 → 3 → 보스 · 원거리형·보스는 단 위 · 낮은 상자는 웅크려야 가려짐 · HP 0 → 2초 뒤 그 자리 부활, 현재 웨이브 재시작 · M: 스테이지 리셋';
